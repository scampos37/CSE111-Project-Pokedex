...
def pokemonBaseStatsSpecific(conn, my_tree, e):
    ...
    my_tree.column("HP", anchor=W, width=70)
    my_tree.column("Attack", anchor=W, width=70)
    my_tree.column("Defense", anchor=W, width=70)
    my_tree.column("SP_Attack", anchor=W, width=70)
    my_tree.column("SP_Defense", anchor=W, width=70)
    my_tree.column("Speed", anchor=W, width=70)
    my_tree.column("Height_m", anchor=W, width=70)
    my_tree.column("Weight_kg", anchor=W, width=70)
    my_tree.heading("#0", anchor=W)
...
def searchLegendaryStatus(conn, my_tree, e):
    ...
    my_tree.column("#0", width=10)
    my_tree.column("Pokedex_Number", anchor=CENTER, width=120)
    my_tree.column("Pokemon_Name", anchor=W, width=200)
...
def pokemonTypingResistances(conn, my_tree, e):
    ...
    my_tree.column("#0", width=10)
    my_tree.column("Pokedex_Number", anchor=CENTER, width=120)
    my_tree.column("Pokemon_Name", anchor=W, width=140)
    my_tree.column("Type_1", anchor=W, width=55)
    my_tree.column("Normal", anchor=W, width=55)
    my_tree.column("Fire", anchor=W, width=55)
    my_tree.column("Water", anchor=W, width=55)
    my_tree.column("Electric", anchor=W, width=55)
    my_tree.column("Grass", anchor=W, width=55)
    my_tree.column("Ice", anchor=W, width=55)
    my_tree.column("Fighting", anchor=W, width=55)
    my_tree.column("Poison", anchor=W, width=55)
    my_tree.column("Ground", anchor=W, width=55)
    my_tree.column("Flying", anchor=W, width=55)
    my_tree.column("Psyhic", anchor=W, width=55)
    my_tree.column("Bug", anchor=W, width=55)
    my_tree.column("Rock", anchor=W, width=55)
    my_tree.column("Ghost", anchor=W, width=55)
    my_tree.column("Dragon", anchor=W, width=55)
    my_tree.column("Dark", anchor=W, width=55)
    my_tree.column("Steel", anchor=W, width=55)
    my_tree.column("Fairy", anchor=W, width=55)
    ...
    try:
        ...
        if (typeNum == "2"):
            ...
            my_tree.column("Pokemon_Name", anchor=W, width=140)
            my_tree.column("Type_1", anchor=W, width=55)
            my_tree.column("Type_2", anchor=W, width=55)
            my_tree.column("Normal", anchor=W, width=55)
            my_tree.column("Fire", anchor=W, width=55)
            my_tree.column("Water", anchor=W, width=55)
            my_tree.column("Electric", anchor=W, width=55)
...
def generationTypingsCount(conn, my_tree, e):
    print("--------------------------------------------")
    genNum = e[0]
    typeNum = e[1]
    type1 = e[2]
